...
const Specials = () => {
  ...
  return (
    <div className="select-none h-fit bg-black grad flex flex-col items-center px-0 py-10  sm:p-20 sm:px-0">
      <h1
        ...
        >
          <div className="bg-black h-1/3 w-[90%] p-10 xl:p-5 rounded-md">
            <div className="flex justify-center items-center h-full w-full">
              <h1 className="text-white text-base md:text-xl xl:text-2xl">
                {t("Artwork")}
              </h1>
            </div>
          </div>
